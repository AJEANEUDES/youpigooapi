    ...
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                ...
                <p class="mb-0">Modifier une Permission</p>
            </div>
        </div>
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Modifier Permission</a></li>
            </ol>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Modifier Une Permission</h4>
                </div>
                <div class="card-body">
                ...
                @endif
                    ...
                    <form action="{{ url('admin/permissions/update/' .  $permission->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="form-group row">
                                        <label class="col-lg-4 col-form-label" for="name">Nom du Permission
