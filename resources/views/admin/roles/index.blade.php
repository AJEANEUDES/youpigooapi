...
@section('title', 'Tableau d\'Administration de Youpigoo -- Gestion des Roles')
    ...
    <div class="card">
        <div class="card-header d-sm-flex d-block">
            <div class="mr-auto mb-sm-0 mb-3">
                <h4 class="card-title mb-2">Liste des rôles</h4>
            ...
            @can('role-create')
                <a href="{{ url('admin/roles/create-role') }}" class="btn btn-info">+ Créer un Nouveau rôle</a>
            @endcan
                        ...
                        @foreach ($roles as $key => $role)
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <h6>
                                            <a href="{{ url('admin/roles/show-role', $role->id) }}">
                                                {{ $role->name }}
                                            </a>
                                        </h6>
                                    </div>
