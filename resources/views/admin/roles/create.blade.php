    ...
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Créer Rôle</a></li>
            </ol>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Créer Un Rôle</h4>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ url('admin/roles/create-role') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control  @error('name') is-invalid @enderror"
                                                ...
                                                autocomplete="name" placeholder="Enter le nom du role">
                                        ...
                                        <div class="form-check">
                                            @foreach ($permission as $value)
                                                <label class="form-check-label"
                                                    for="inlineCheckbox1">{{ Form::checkbox('permission[]', $value->id, false, ['class' => 'name']) }}
                                                    {{ $value->name }}</label>
                                                <br />
                                            @endforeach
                                        </div>
