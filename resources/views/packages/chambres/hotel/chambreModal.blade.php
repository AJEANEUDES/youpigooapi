<form action="{{ route('chambres.store.gestion') }}" method="post" enctype="multipart/form-data" id="chambres-store-gestion">
    @csrf
                ...
                <div class="modal-body row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select style="height: 55px;border-radius: 10px;" class="form-control form-control-lg"
                            ...
                            <option value="{{ encodeId($categoriechambre->id_categoriechambre) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <select style="height: 55px;border-radius: 10px;" class="form-control form-control-lg"
                            ...
                            <option value="{{ encodeId($hotel->id_hotel) }}">{{ Str::upper($hotel->nom_hotel) }}
                            </option>
                            @endforeach
                        </select>
                    </div>
