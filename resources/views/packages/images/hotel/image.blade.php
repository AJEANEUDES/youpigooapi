            ...
            <div class="card">
                <div class="card-body" style="overflow: auto;">
                    <h5 class="card-title" style="text-align: center;font-size: 25px;">Enregistrement des images de
                        Chambres</h5>
                    <form action="{{ route('images-chambres.store.gestion') }}" method="post" enctype="multipart/form-data"
                        id="images-chambres-store-gestion">
                        @csrf
                        <div class="row g-3">
...
<div class="modal fade" id="updateImageModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('images-chambres.update.gestion') }}" method="post" enctype="multipart/form-data" id="images-chambres-update-gestion">
                @csrf
...
{{-- Modal pour supprimer une image de chmabre --}}
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('images-chambres.delete.gestion') }}" method="post" id="images-chambres-delete-gestion">
                    @csrf
...
<script>
    ...
    //Pour obtenir les informations d'une marquimagee grace a l'identifiant
    $(document).on('click', '#getInfosImage', function(){
        ...
        $.ajax({
            type: 'GET',
            url: '{{ route('images-chambres.info.gestion') }}',
            dataType: 'JSON',
            data: {id_image:id_image},
            success: (response)=>{
    ...
    //Nouveau code pour uploader image chambre
    $(function(){
