        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                    ...
                    <form action="{{ url('Admin/administrateur/mot-de-passe') }}" method="post" id="admins-update-mdp">
                        @csrf
                        <input type="hidden" name="id_admin" class="id_admin" value="{{ (Auth::id()) }}">
                        <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                    ...
                    <form action="{{ route('Admin/administrateur/update-profile-admin') }}" method="post" enctype="multipart/form-data" id="admins-profile-update">
                        @csrf
                        <input type="hidden" name="id_admin" class="id_admin" value="{{ (Auth::id()) }}">
                        <div class="row">
        ...
        $(document).ready(function(){
            ...
            $.ajax({
                ...
                success: (response)=>{
                    ...
                    $("#admins-profile-update").find('input[name="prenoms_user"]').val(response.prenoms_user);
