...
@section('main')
    ...
    <div class="modal fade" id="updateServiceModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="{{ route('services-chambres.update') }}" method="post" id="services-chambres-update">
                    @csrf
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('services-chambres.delete') }}" method="post" id="services-chambres-delete">
                        @csrf
    ...
    @include('packages.services.admin.serviceModal')
@endsection
