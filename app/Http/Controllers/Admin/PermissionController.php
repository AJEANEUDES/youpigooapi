...
class PermissionController extends Controller
{
    ...
    {
        $permissions = Permission::orderBy('id','DESC')->paginate(10000);
    ...
    public function create()
    {
        ...
        return view('admin.permissions.create',compact('role'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.permissions.show',compact('permission','rolePermissions'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/ermissions')
